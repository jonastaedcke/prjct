...
?></div><div class="info"><div class="more"><div class="url"><a href="<?php echo "/".$project["url"] ?>/"><?php echo "/".$project["url"] ?>/</a></div></div><div class="desc"><?php echo str_replace("\n", '', $Parsedown->text($part["desc"])) ?></div><?php
